...
const RootedAndDriven: React.FC = () => {
  return (
    <div className=" section-padding space-y-[80px] py-[120px] bg-[#15221B] overflow-hidden text-white relative mt-[200px]">
      <div className="space-y-[40px]">
        <h1 className="text-[57px] font-[600] bg-gradient-to-b from-[#38423D] to-[#8EA89A] bg-clip-text text-transparent text-nowrap text-center opacity-[0.2]">
        ...
        <div className="relative flex justify-center">
          <div className="">
            <StackedProducts
              type="beans"
              className="absolute mt-0 bottom-0 sm:bottom-0 lg:bottom-0 scale-[0.7] translate-x-[-140px] "
            />
          </div>
          <StackedProducts
            type="rice"
          ...
          <div className="absolute">
            <StackedProducts
              type="beans"
              className="relative mt-0 bottom-0 sm:bottom-0 lg:bottom-0 scale-[0.7] translate-x-[140px] "
            />
          </div>
        </div>
        ...
        <div className="flex justify-center relative text-white">
          <h3 className="w-[95%] text-center text-[18px] lg:text-[20px] font-satoshi font-[500] text-[#8A908D] relative">
            <span className="text-[24px] lg:text-[32px] font-[900] text-white">
              Garri
            </span>
            , a staple derived from cassava roots.{" "}
            <span className="text-[32px] font-[900] text-white">
              Plantain Flour
            </span>{" "}
        ...
        <div className="flex mt-[60px] justify-between gap-[40px] items-center p-[23.82px] lg:p-[40px] rounded-[19.05px] lg:rounded-[32px] bg-[#111C16]">
          <img
            src={dinner}
            alt=""
            className="w-[46%] shrink-1 rounded-[12.45px]"
          />
          <h2 className="text-[24px] lg:text-[40px] font-[700] leading-[40px] lg:leading-[72px] tracking-[-2%]">
