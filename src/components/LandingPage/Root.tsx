  ...
  return (
    <div className="relative mt-60">
      <div className="section-padding pr-0 flex items-center justify-between w-full overflow-x-hidden">
        ...
        <div className="">
          <img src={pattern} alt="" className=" w-[150px] h-[150px] sm:size-[278px] lg:size-[480px] rounded-full sm:translate-x-[70px] absolute top-[-100px] right-[-50px] sm:top-0 sm:right-0 sm:relative object-cover" />
        </div>
      </div>
    </div>
  );
