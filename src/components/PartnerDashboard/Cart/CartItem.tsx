      ...
      <div className="flex flex-col justify-between items-end">
        ...
        <div className="px-2 py-2 bg-[#F9F9F9] rounded-[8px] flex items-center gap-3 text-[#6E6E6E] font-satoshi">
          ...
          className=" cursor-pointer">
            { adding || removing ? <Loader2 className="animate-spin size-[15px]" /> : <Minus className="size-[15px]" />}
          </button>
          {item.quantity}
          <button
            disabled={adding || removing}
          ...
          className="cursor-pointer">
            { adding || removing ? <Loader2 className="animate-spin size-[15px]" /> : <Plus className="size-[15px]" />}
